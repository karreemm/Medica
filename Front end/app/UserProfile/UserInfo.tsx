...
import person from '/app/person.jpg';
...
return (
    <>
    {role != "admin" && 
    <div className="group h-20 transition-all duration-300 ease-out hover:ease-in hover:h-[400px] max-[1050px]:hover:h-[500px]  shadow-2xl rounded-3xl 
        ...
        <div className="relative flex flex-row justify-between items-start">
            ...
            {/* title */}
            <h1 className={`text-nowrap transition-opacity ease-in duration-50  opacity-0 group-hover:opacity-100
             ml-2 pacifico-font text-3xl mb-5 text-[#fdf0d5]  
             `}>Personal info</h1>

            {/* image */}
            <div className={`absolute  transition-opacity ease-in duration-50  group-hover:opacity-0 opacity-100
                flex flex-row justfiy-start items-center gap-x-5
        ...
        {/* personal info content */}
         <div className={`p-4 flex flex-row flex-wrap justify-between gap-y-10  rounded-3xl
            ...
            <div className="basis-[40%] 
                            transition-translate ease-out duration-100  group-hover:translate-y-0 -translate-y-[150%]
                            ">
            ...
            {/* phone */}
            <div className="basis-[40%]
                            transition-translate ease-out duration-100  group-hover:translate-y-0 -translate-y-[300%]
                            ">
                <div className="flex flex-row items-center gap-x-2">
         ...
         <div className={`my-8 flex flex-row content-end justify-center gap-x-3 
                          transition-translate ease-out duration-300 delay-200  group-hover:translate-y-0 -translate-y-[50vw]
